...
function plotOneUnit(unitData, typeNumber, typeName)
    ...
    hold on;
    diagLabel = sprintf('type%d unit%d', typeNumber, unitData.UnitNumber);
    plotSweepPair(cleanTrace(unitData.NaiveLow, [diagLabel ' naive low']), ...
                  cleanTrace(unitData.NaiveHigh, [diagLabel ' naive high']), ...
                  naiveColor, 1.0, 'Naive');
    plotSweepPair(cleanTrace(unitData.SmartCoarseLow, [diagLabel ' coarse low']), ...
                  cleanTrace(unitData.SmartCoarseHigh, [diagLabel ' coarse high']), ...
                  coarseColor, 1.5, 'Coarse');
    plotSweepPair(cleanTrace(unitData.SmartFineLow, [diagLabel ' fine low']), ...
                  cleanTrace(unitData.SmartFineHigh, [diagLabel ' fine high']), ...
                  fineColor, 2.5, 'Fine');
    ...
    title(unitLabel(typeNumber, typeName, unitData.UnitNumber));
